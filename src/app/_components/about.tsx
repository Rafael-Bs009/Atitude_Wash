    ...
    <section className="bg-orange-50 py-20">
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12  px-6">
        <div>
          ...
          >
            <div>
              <h1 className="text-5xl text-start mb-16 font-bold text-primary font-montserrat tracking-wide">
                Sobre
              </h1>
              <p className="text-gray-700 text-lg leading-relaxed font-work-sans max-w-3xl mx-auto">
          ...
          >
            <div>
              ...
              <p className="text-gray-700  leading-relaxed font-work-sans">
                Proporcionar ambientes mais saudáveis e modernos por meio de uma{" "}
                <strong>
          ...
          >
            <div>
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-4 font-work-sans">
                ...
                <li>
                  <strong>Qualidade e Confiança:</strong> Resultados que superam
                  expectativas com transparência.
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="text-gray-700 font-work-sans">
                {[
                  ...
                  <li
                    key={index}
                    className="flex items-center w-fit px-4 py-2 rounded-full text-sm"
                  >
        ...
        >
          <div className="flex justify-end text-primary">
            <a
              href="#"
              className="flex justify-between items-center gap-2 border-b border-primary cursor-pointer"
            >
